...
[`sheppyd`](../guides/sheppyd); live machine connections and the topics "live"
column are placeholders until multi-machine launch and live introspection land
(see the [roadmap](../architecture#roadmap)).
...
to your manifest (e.g. `profiles/mock.yaml`); the filename is the
...
- Nodes that aren't in this manifest stay under the
  [orphans](../guides/sheppyd#orphans) divider.
